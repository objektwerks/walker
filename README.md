Walker
------
>Walker app using ScalaFX, ScalikeJdbc, Jsoniter, JoddMail, Helidon, PostgreSql and Scala 3.
...
1. java -jar .assembly/walker-mac-0.5.jar
2. java -jar .assembly/walker-m1-0.5.jar
3. java -jar .assembly/walker-win-0.5.jar
4. java -jar .assembly/walker-linux-0.5.jar
