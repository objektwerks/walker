...
1. java -jar .assembly/walker-mac-0.8.jar
2. java -jar .assembly/walker-m1-0.8.jar
3. java -jar .assembly/walker-win-0.8.jar
4. java -jar .assembly/walker-linux-0.8.jar
