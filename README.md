...
1. java -jar .assembly/walker-mac-0.10.jar
2. java -jar .assembly/walker-m1-0.10.jar
3. java -jar .assembly/walker-win-0.10.jar
4. java -jar .assembly/walker-linux-0.10.jar
